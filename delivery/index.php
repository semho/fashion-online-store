...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=COST_DELIVERY?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=MIN_PRICE_PRODUCT?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=COST_EXPRESS_DELIVERY?> РУБ</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=COST_DELIVERY?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=MIN_PRICE_PRODUCT?> РУБ)</b>
        <p class="page-delivery__item-desc">
